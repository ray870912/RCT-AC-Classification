...
path = "/Users/ray/Thesis/Shoulder/Extension_120/"
...
for fileName in allFileList:
  ...
  if not fileName.startswith('.') and os.path.isfile(os.path.join(path, fileName)):
    ...
    # cv2.imwrite("/Users/ray/Thesis/Input/output/"+str(fileName[0:5])+"fisrt.jpg", image)
...
np.savetxt("extension_HC.csv", allFeature, fmt="%s", delimiter=",", header=header)