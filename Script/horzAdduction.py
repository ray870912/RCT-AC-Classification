...
path = "/Users/ray/Thesis/Shoulder/Horizontal Adduction_120/"
...
for fileName in allFileList:
  ...
  if continueProc == True:
    ...
    # Reduce Data Size -> normalize to 60 Frames
    ...
    if StartEndFrames >= 60:
      ...
      for i in splitList:
        ...
        utils.getHorzAngle(startShoulder, startElbow, currentShoulder, currentElbow, type='add')
...
np.savetxt("horzAdduction_HC.csv", allFeature, fmt="%s", delimiter=",", header=header)